...
{
    var xray_details = $("#xray_details").data("val");
   
    var PatientData = $("#patient_data").data("val");

    console.log(PatientData)
    console.log(xray_details)
        ...
        if (xray_details.length != 0) {


          xray_details.map(function(obj) {
            var AppendText = '<tr>\
                                <td>'+obj.xray_name+'</td>\
                                <td class="text-end">'+obj.xray_amount+'</td>\
                            </tr>';
